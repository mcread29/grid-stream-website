...
namespace Firesplash.GameDevAssets.SocketIOPlus
{
    ...
    public class SocketIONamespace
    {
        ...
        internal void Connect(object authPayload)
        {
            ...
            client.Send(new SocketIOPacket(PacketType.CONNECT, authPayloadList, null, 0, null, this));
        }
        ...
        public void Disconnect()
        {
            ...
            shallConnect = false;
            client.SendEngineIOPackets(client.GetParser().Encode(new SocketIOPacket(PacketType.DISCONNECT, null, null, -1, null, this), client));
        }
        ...
        public void On(string eventName, UnityAction callback)
        {
            ...
            registeredUnityEventHandlers[eventName].AddListener((e) => {
                if (e.payloads != null && e.payloads.Count > 0) return;
                callback.Invoke();
            });
        }
